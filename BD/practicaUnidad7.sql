...
--
-- Servidor: localhost
-- Tiempo de generación: 07-04-2026 a las 20:11:51
...
--
-- Autor: Usuarios de prueba creados por defecto para cada situación, en formato SHA1
-- admin - admin
-- user1 - 1234
-- user2 - abcd
-- user3 - 0000
...
(1, 'admin', '$2y$10$c4HRABw0K6OwN2QI2X6E5eWobQJTmbgmzQ.MUolR4D3YPwHO98Udm'),
(2, 'user1', '$2y$10$Uh7J8uNNiDpFm5T8zjFdNOPE3WgwwBLM22mlVg84CHtsXKq3pSY3W'),
(3, 'user2', '$2y$10$PoBsyUe9mSJnhKTZxBOnLOppDTYIxT7VF6iy.7Q9vG5LTrfxnzgim'),
(4, 'user3', '$2y$10$7f4sqwreriyzp2PK31AVOuw4uPDKLJvRfXa9eQXu42Ainp8ZMpTmO');
